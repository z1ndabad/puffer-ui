...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium shadow-btn transition-all hover:shadow-btn-hover focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-700 focus-visible:ring-offset-2 active:shadow-btn-active disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
